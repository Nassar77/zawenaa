        ...
        <form action="#">
            ...
            <div class="form-group">
                ...
                <select id="category" name="category">
                    <option value=" All Categoties"> All Categoties</option>
            ...
            <div class="form-group">
                ...
                <select id="location" name="location">
                    ...
                    <option value=" Al Mansoura ">Al Mansoura</option>
                </select>
            </div>
    ...
    <div class="jobs">
        ...
        <ul class="jop0">
            <li class="job">
                ...
                <p>Company [Company Name] is looking for a talented software engineer to join its team.</p>
                <dl class="jp1">
                    <dt>
                        Job Description
                    </dt>
                    <dd> Specialization:  </dd>
                    <dd> Type of disability :</dd>
                    <dd>Type of Working Hours :</dd>
                </dl>
                <a class="jp2" href="[رابط الوظيفة]"> Job Details</a>
            </li>
            <li class="job">
